...
#add by lct begin device/mediateksample/p11_lte/BoardConfig.mk
#default 6M
...
#add by lct for firewall
ifeq ($(PRC_CONFIG),true)
KERNEL_CONFIG_WANTJOIN_FIREWALL := CONFIG_WANTJOIN_FIREWALL=y
else
KERNEL_CONFIG_WANTJOIN_FIREWALL := CONFIG_WANTJOIN_FIREWALL=n
endif
...
$(TARGET_KERNEL_CONFIG): $(KERNEL_MAKE_DEPENDENCIES)
	...
	$(hide) if [ "$(KERNEL_CONFIG_LCT_OVERRIDE)" == "yes" ]; then \
		...
		echo $(KERNEL_CONFIG_WANTJOIN_FIREWALL) >> $(KERNEL_OUT)/.config; \
