...
#define AS33970_BOOT_WITHOUT_FLASH     //enable this option when firmware need to be downloaded externally
//#define AS33970_NEED_SET_I2C_SPEED   //enable this option if it need to set the I2C clock
...
#define AS33970_I2C_SPEED_MIN (100000) //100khz
#define AS33970_I2C_SPEED_MAX (1000000) //1Mhz
