...
#define DBMDX_MELON_BARGEIN_GA_MODE
/* Melon transfer speaker data Usecase */
static struct usecase_config config_uc_melon_transfer_spk_data = {
#if defined(DBMDX_MELON_SRATE_48000)
	.usecase_name = "uc_melon_48k_spk_data",
#else
	.usecase_name = "uc_melon_16k_spk_data",
#endif
	.id	= (0xa00 |
			DBMDX_USECASE_ID_PRJ_MELON |
			DBMDX_USECASE_ID_HWREV_00),
