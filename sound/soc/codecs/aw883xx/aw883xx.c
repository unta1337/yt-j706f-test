...
int is_aw883xx_smartpa = false;
EXPORT_SYMBOL_GPL(is_aw883xx_smartpa);
				...
				const struct i2c_device_id *id)
{
	...
	i2c->addr = i2c->addr - 0x10;
	aw_dev_info(&i2c->dev, "i2c->addr 0x%x, 20211108", i2c->addr);
