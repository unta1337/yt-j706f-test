...
static const struct snd_pcm_hardware mt6785_hostless_hardware = {
...
static const struct snd_soc_dapm_route mtk_dai_hostless_routes[] = {
	...
	{"PCM_1_PB_CH1", "I2S2_CH1", "Hostless Speech DL"},
	{"PCM_1_PB_CH2", "I2S2_CH2", "Hostless Speech DL"},
	{"PCM_2_PB_CH1", "I2S2_CH1", "Hostless Speech DL"},
	{"PCM_2_PB_CH2", "I2S2_CH2", "Hostless Speech DL"},
	{"Hostless Speech UL", NULL, "I2S2"},

#ifndef CONFIG_TARGET_PROJECT_P530
	{"PCM_1_PB_CH1", "I2S0_CH1", "Hostless Speech DL"},
	{"PCM_1_PB_CH2", "I2S0_CH2", "Hostless Speech DL"},
				    ...
				    struct snd_soc_dai *dai)
{
	...
	snd_soc_set_runtime_hwparams(substream, &mt6785_hostless_hardware);
...
static struct snd_soc_dai_driver mtk_dai_hostless_driver[] = {
	...
	},
	{
		...
		.id = MT6785_DAI_HOSTLESS_SPH_ECHO_REF,
		.playback = {
	...
	},
	{
		...
		.id = MT6785_DAI_HOSTLESS_SPK_INIT,
		.playback = {
	...
	},
	{
		...
		.id = MT6785_DAI_HOSTLESS_IMPEDANCE,
		.playback = {
	...
	},
	{
		...
		.id = MT6785_DAI_HOSTLESS_SRC_BARGEIN,
		.playback = {
