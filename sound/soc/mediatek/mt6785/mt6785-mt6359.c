...
static int get_p522_spk_mode(struct snd_kcontrol *kcontrol,
			       struct snd_ctl_elem_value *ucontrol)
{
	int idx = p522_spk_mode;
...
static const struct snd_kcontrol_new mt6785_mt6359_controls[] = {
	...
	SOC_ENUM_EXT("P522_SPK_TYPE_GET", mt6785_spk_type_enum[0],
		     get_p522_spk_mode, NULL),
};
...
extern uint16_t cs35l41_pa_status(void);
#endif

#ifdef CONFIG_SND_SMARTPA_AW881XX
static struct snd_soc_dai_link_component aw881xx_codecs[] = {
	{
...
static struct snd_soc_dai_link_component aw883xx_codecs[] = {
	{
		.name = "aw883xx_smartpa.6-0044",
		.dai_name = "aw883xx-aif-6-34",
	},
	{
		.name = "aw883xx_smartpa.6-0045",
		.dai_name = "aw883xx-aif-6-35",
	},
	{
		.name = "aw883xx_smartpa.6-0046",
		.dai_name = "aw883xx-aif-6-36",
	},
	{
		.name = "aw883xx_smartpa.6-0047",
...
static struct snd_soc_dai_link mt6785_mt6359_dai_links[] = {
	...
	},
	{
		...
		.ignore_suspend = 1,
		.be_hw_params_fixup = mt6785_i2s_hw_params_fixup,
		//gy add start use i2s1 mclk add by zpc
		.ops = &mt6785_mt6359_i2s_ops,
	},
	{
		.name = "I2S2",
		...
		.codec_dai_name = "as33970-aif",
		.codec_name = "as33970.9-0041",
#else
		.codec_dai_name = "snd-soc-dummy-dai",
		.codec_name = "snd-soc-dummy",
#endif
		...
		.ignore_suspend = 1,
		.be_hw_params_fixup = mt6785_i2s_hw_params_fixup,
#ifndef CONFIG_TARGET_PROJECT_P530
//as33970 use bclk instead of mclk
		.ops = &mt6785_mt6359_i2s_ops,
#endif
	},
	{
...
#ifdef CONFIG_SND_SMARTPA_AW881XX
extern uint16_t aw881xx_get_chipid(void);
#endif

#ifdef CONFIG_SND_SMARTPA_AW883XX
extern int is_aw883xx_smartpa;
#endif
...
static int mt6785_mt6359_dev_probe(struct platform_device *pdev)
{
...
#ifdef CONFIG_SND_SMARTPA_AW881XX
	if (aw881xx_get_chipid() == 0x1806) {
	        p522_spk_mode = 5;
		mt6785_mt6359_dai_links[spk_out_dai_link_idx].codecs = aw881xx_codecs;
		mt6785_mt6359_dai_links[spk_out_dai_link_idx].num_codecs = ARRAY_SIZE(aw881xx_codecs);
		mt6785_mt6359_dai_links[spk_out_dai_link_idx].codec_dai_name = NULL;
		mt6785_mt6359_dai_links[spk_out_dai_link_idx].codec_name = NULL;
	} else
#endif
#ifdef CONFIG_SND_SMARTPA_AW883XX
	if (true == is_aw883xx_smartpa) {
		p522_spk_mode = 6;
		mt6785_mt6359_dai_links[spk_out_dai_link_idx].codecs = aw883xx_codecs;
		mt6785_mt6359_dai_links[spk_out_dai_link_idx].num_codecs = ARRAY_SIZE(aw883xx_codecs);
		mt6785_mt6359_dai_links[spk_out_dai_link_idx].codec_dai_name = NULL;
		mt6785_mt6359_dai_links[spk_out_dai_link_idx].codec_name = NULL;
	}
#endif
	dev_info(&pdev->dev, "p522 spk mode %d\n", p522_spk_mode);
	...
	if (cirrus_prince_devs == cs35l41_pa_status()) {
		mt6785_mt6359_dai_links[spk_out_dai_link_idx].codecs = cirrus_prince;
		mt6785_mt6359_dai_links[spk_out_dai_link_idx].num_codecs = ARRAY_SIZE(cirrus_prince);
		mt6785_mt6359_dai_links[spk_out_dai_link_idx].ops = &cs35l41_be_ops;
		mt6785_mt6359_dai_links[spk_out_dai_link_idx].init = cs35l41_mi2s_snd_init;
		mt6785_mt6359_dai_links[spk_out_dai_link_idx].ignore_pmdown_time = 1;
		dev_info(&pdev->dev, "%s cs35l41 register success", __func__);
	} else {
		mt6785_mt6359_dai_links[spk_out_dai_link_idx].codec_dai_name = "snd-soc-dummy-dai";
		mt6785_mt6359_dai_links[spk_out_dai_link_idx].codec_name = "snd-soc-dummy";
	}
#endif
	...
	if (ret)
		...
		dev_info(&pdev->dev, "%s snd_soc_register_card success", __func__);
	return ret;
}
