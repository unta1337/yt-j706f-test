...
#endif
#if defined(S5K4H7TXD_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5K4H7TXD_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{SensorMCLK, Vol_High, 1},
			{DVDD, Vol_High, 1},
...
/* P522 */
	...
	{
		SENSOR_DRVNAME_OV13B10OFILM_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{SensorMCLK, Vol_High, 1},
			{DVDD, Vol_High, 1},
...
#endif
#if defined(S5K4H7YXLCE_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5K4H7YXLCE_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{SensorMCLK, Vol_High, 1},
			{DVDD, Vol_High, 1},
...
#endif
#if defined(OV13B10QTECH_MIPI_RAW)
	{
		SENSOR_DRVNAME_OV13B10QTECH_MIPI_RAW,
		{
			{RST, Vol_Low, 1},
			{SensorMCLK, Vol_High, 1},
			{DVDD, Vol_High, 1},
