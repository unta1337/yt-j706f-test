...
#if 0
extern int ov8856sub_af_mac;
extern int ov8856sub_af_inf;
extern int ov8856sub_af_lsb;

extern int ov8856sub_awb_R;
extern int ov8856sub_awb_B;
extern int ov8856sub_awb_Gr;
extern int ov8856sub_awb_Gb;
extern int ov8856sub_awb_lsb;
#endif
...
static kal_uint16 ov8856sub_table_write_cmos_sensor(kal_uint16 *para, kal_uint32 len)
{
...
kal_uint16 addr_data_pair_init_ov8856sub[] = {
	0x0103, 0x01,
	0x0300, 0x05, //mclk 26M 20210528
	0x0302, 0x6f, //mclk 26M 20210528
	0x0303, 0x00,
	0x030b, 0x05, //mclk 26M 20210528
	0x030d, 0x6f, //mclk 26M 20210528
	0x031e, 0x0c,
	0x3000, 0x00,
	0x300e, 0x00,
	0x3010, 0x00,
...
static void sensor_init(void)
{
	LOG_INF("v3 E\n");
#if 1	/* MULTI_WRITE */
	ov8856sub_table_write_cmos_sensor(addr_data_pair_init_ov8856sub,
			   sizeof(addr_data_pair_init_ov8856sub) / sizeof(kal_uint16));
#endif
...
*
*************************************************************************/
kal_uint16 addr_data_pair_preview_ov8856sub[] = {
	0x0300, 0x05, //mclk 26M 20210528
	0x0302, 0x6f, //mclk 26M 20210528
	0x0303, 0x00,
	0x030b, 0x05, //mclk 26M 20210528
...
#endif
	ov8856sub_table_write_cmos_sensor(addr_data_pair_preview_ov8856sub,
				   sizeof(addr_data_pair_preview_ov8856sub) / sizeof(kal_uint16));
...
*
*************************************************************************/
kal_uint16 addr_data_pair_capture_30fps_ov8856sub[] = {
	0x0300, 0x05, //mclk 26M 20210528
	0x0302, 0x6f, //mclk 26M 20210528
	0x0303, 0x00,
	0x030b, 0x05, //mclk 26M 20210528
...
kal_uint16 addr_data_pair_capture_15fps_ov8856sub[] = {
	0x0300, 0x05, //mclk 26M 20210528
	0x0302, 0x6f, //mclk 26M 20210528
	0x0303, 0x00,
	0x030b, 0x05, //mclk 26M 20210528
...
#endif
	if (currefps == 150) {
		ov8856sub_table_write_cmos_sensor(addr_data_pair_capture_15fps_ov8856sub,
					       sizeof(addr_data_pair_capture_15fps_ov8856sub) /
					       sizeof(kal_uint16));
	} else {
		ov8856sub_table_write_cmos_sensor(addr_data_pair_capture_30fps_ov8856sub,
					       sizeof(addr_data_pair_capture_30fps_ov8856sub) /
					       sizeof(kal_uint16));
...
kal_uint16 addr_data_pair_vga_setting_120fps_ov8856sub[] = {
	0x3501, 0x25,
	0x3502, 0xc0,
	0x366e, 0x08,
	0x3714, 0x29,
...
static void vga_setting_120fps(void)
{
	...
	ov8856sub_table_write_cmos_sensor(addr_data_pair_vga_setting_120fps_ov8856sub,
				   sizeof(addr_data_pair_vga_setting_120fps_ov8856sub) /
				   sizeof(kal_uint16));
