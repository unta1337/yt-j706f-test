 ...
 * Setting version:
 * ------------
 *   update full pd setting for OV13B10_SUNNY_QTECH_AM04
 *------------------------------------------------------------------------------
...
#define PFX "OV13B10QTECH_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV13B10QTECH_SENSOR_ID,
...
static kal_uint16 ov13b10qtech_table_write_cmos_sensor(
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_ov13b10qtech[] = {
0x0103,0x01, 
0x0303,0x01, 
0x0305,0x46, 
0x0321,0x00, 
...
static void sensor_init(void)
{
	...
	ov13b10qtech_table_write_cmos_sensor(
		addr_data_pair_init_ov13b10qtech,
		sizeof(addr_data_pair_init_ov13b10qtech) / sizeof(kal_uint16));
#else
	LOG_DBG("sensor_init\n");
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_ov13b10qtech[] = {
0x0305,0x46,
0x0325,0x50,
0x3501,0x0c,
0x3502,0x10,
...
0x380e,0x0c,
0x380f,0x7c,
0x3811,0x11, // follow pd calibration setting
0x3813,0x08,
0x3814,0x01,
0x3815,0x01,
0x3816,0x01,
0x3817,0x01,
0x3820,0xb0, //mirror_flip on RGGB
0x3c8c,0x19,
0x4008,0x02,
0x4009,0x0f,
0x4050,0x02,
...
#if MULTI_WRITE
	ov13b10qtech_table_write_cmos_sensor(
		addr_data_pair_preview_ov13b10qtech,
		sizeof(addr_data_pair_preview_ov13b10qtech) /
				sizeof(kal_uint16));
#else
//	write_cmos_sensor(0x0100, 0x00);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_15fps_ov13b10qtech[] = {
0x0305,0x46,
0x0325,0x50,
0x3501,0x0c,
0x3502,0x10,
...
0x380e,0x0c,
0x380f,0x7c,
0x3811,0x11, // follow pdcalibration setting
0x3813,0x08,
0x3814,0x01,
0x3815,0x01,
0x3816,0x01,
0x3817,0x01,
0x3820,0xb0, // mirror_flip_on RGGB
0x3c8c,0x19,
0x4008,0x02,
0x4009,0x0f,
0x4050,0x02,
...
kal_uint16 addr_data_pair_capture_30fps_ov13b10qtech[] = {
0x0305,0x46,
0x0325,0x50,
0x3501,0x0c,
0x3502,0x10,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 150) {
		ov13b10qtech_table_write_cmos_sensor(
			addr_data_pair_capture_15fps_ov13b10qtech,
			sizeof(addr_data_pair_capture_15fps_ov13b10qtech) /
			sizeof(kal_uint16));
	} else {
		ov13b10qtech_table_write_cmos_sensor(
			addr_data_pair_capture_30fps_ov13b10qtech,
			sizeof(addr_data_pair_capture_30fps_ov13b10qtech) /
			sizeof(kal_uint16));
	}
#else
if (currefps == 150) {
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_video_ov13b10qtech[] = {
0x0305,0x46,
0x0325,0x50,
0x3501,0x0c,
0x3502,0x10,
...
#if MULTI_WRITE
	ov13b10qtech_table_write_cmos_sensor(
		addr_data_pair_video_ov13b10qtech,
		sizeof(addr_data_pair_video_ov13b10qtech) /
		sizeof(kal_uint16));
#else
	//write_cmos_sensor(0x0100, 0x00);
	write_cmos_sensor(0x0305, 0x23);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_ov13b10qtech[] = {
0x0305,0x23,
0x0325,0x50,
0x3501,0x03,
0x3502,0x00,
...
0x3816,0x03,
0x3817,0x01,
0x3820,0xb3, // mirror_flip_on RGGB
0x3c8c,0x18,
0x4008,0x00,
0x4009,0x05,
0x4050,0x00,
...
#if MULTI_WRITE
	ov13b10qtech_table_write_cmos_sensor(
		addr_data_pair_hs_video_ov13b10qtech,
		sizeof(addr_data_pair_hs_video_ov13b10qtech) /
		sizeof(kal_uint16));
#else
	//write_cmos_sensor(0x0100, 0x00);
	write_cmos_sensor(0x0305, 0x23);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_ov13b10qtech[] = {
0x0305,0x23,
0x0325,0x50,
0x3501,0x06,
0x3502,0x00,
...
#if MULTI_WRITE
	ov13b10qtech_table_write_cmos_sensor(
		addr_data_pair_slim_video_ov13b10qtech,
		sizeof(addr_data_pair_slim_video_ov13b10qtech) /
		sizeof(kal_uint16));
#else
	//write_cmos_sensor(0x0100, 0x00);
	write_cmos_sensor(0x0305, 0x23);
...
static kal_uint16 get_qtech_module_id(void)
{
	kal_uint16 get_byte = 0;
	char pusendcmd[2] = {(char)(0x0B >> 8), (char)(0x0B & 0xFF) };
...
{
	kal_uint8 i = 0;
	kal_uint8 retry = 2, module_id = 0;

	module_id = get_qtech_module_id();
			...
			if (module_id == 0x06) {
				*sensor_id = return_sensor_id();
				if (*sensor_id == imgsensor_info.sensor_id) {
					LOG_ERR("ov13b10qtech i2c write id: 0x%x, sensor id: 0x%x module_id: 0x%x\n",
					imgsensor.i2c_write_id,
					*sensor_id,
					module_id);
					return ERROR_NONE;
				} else {
					LOG_ERR("ov13b10qtech check id i2c write id: 0x%x, sensor id: 0x%x module_id: 0x%x\n",
					imgsensor.i2c_write_id,
					*sensor_id,
					module_id);
				...
				LOG_ERR("Read sensor id fail:0x%x, id: 0x%x, module_id: 0x%x\n",
	...
	if (*sensor_id != imgsensor_info.sensor_id) {
		LOG_ERR("imgsensor id: 0x%x fail\n", *sensor_id);
		*sensor_id = 0xFFFFFFFF;
...
#if ENABLE_PDAF
	sensor_info->PDAF_Support = PDAF_SUPPORT_RAW; //1;
#endif
...
UINT32 OV13B10QTECH_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
