...
#include "ov13b10ofilmmipiraw_Sensor.h"
...
static kal_uint16 get_ofilm_module_id(void)
{
	kal_uint16 get_byte = 0;
			...
			if (module_id == 0x07) {
				*sensor_id = return_sensor_id();
				if (*sensor_id == imgsensor_info.sensor_id) {
					pr_info("ov13b10ofilm i2c write id: 0x%x, sensor id: 0x%x module_id: 0x%x\n",
					imgsensor.i2c_write_id,
					*sensor_id,
					module_id);
					return ERROR_NONE;
				} else {
					pr_err("ov13b10ofilm check id i2c write id: 0x%x, sensor id: 0x%x module_id: 0x%x\n",
					imgsensor.i2c_write_id,
					*sensor_id,
					module_id);
