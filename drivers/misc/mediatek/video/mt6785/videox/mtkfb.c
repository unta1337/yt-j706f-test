...
//add lcd_name node 2020.12.03 start
...
static int lcd_ntc_create_sysfs(void)
{
   ...
   if(lcd_name == NULL) {
	...
	printk("create android lcd directory success\n");
   }
   ...
   if(ret) {
	...
	printk("create lcd name file success\n");
   }

   return 0;
}
//add lcd_name node 2020.12.03 end
