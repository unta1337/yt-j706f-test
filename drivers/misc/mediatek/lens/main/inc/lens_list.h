...
#define DW9763OFILMAF_SetI2Cclient DW9763OFILMAF_SetI2Cclient_Main
#define DW9763OFILMAF_Ioctl DW9763OFILMAF_Ioctl_Main
#define DW9763OFILMAF_Release DW9763OFILMAF_Release_Main
#define DW9763OFILMAF_GetFileName DW9763OFILMAF_GetFileName_Main
extern int DW9763OFILMAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				  spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long DW9763OFILMAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			    unsigned long a_u4Param);
extern int DW9763OFILMAF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int DW9763OFILMAF_GetFileName(unsigned char *pFileName);

#define DW9763QTECHAF_SetI2Cclient DW9763QTECHAF_SetI2Cclient_Main
#define DW9763QTECHAF_Ioctl DW9763QTECHAF_Ioctl_Main
#define DW9763QTECHAF_Release DW9763QTECHAF_Release_Main
#define DW9763QTECHAF_GetFileName DW9763QTECHAF_GetFileName_Main
extern int DW9763QTECHAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				  spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long DW9763QTECHAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			    unsigned long a_u4Param);
extern int DW9763QTECHAF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int DW9763QTECHAF_GetFileName(unsigned char *pFileName);
