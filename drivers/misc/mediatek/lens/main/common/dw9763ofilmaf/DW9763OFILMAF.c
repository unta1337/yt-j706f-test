...
/*
 * DW9763OFILMAF voice coil motor driver
 *
 *
 */
...
#define AF_DRVNAME "DW9763OFILMAF_DRV"
...
static int s4DW9763OFILMAF_ReadReg(unsigned short *a_pu2Result)
{
...
/* ////////////////////////////////////////////////////////////// */
long DW9763OFILMAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int DW9763OFILMAF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	unsigned long temp;
...
int DW9763OFILMAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int DW9763OFILMAF_GetFileName(unsigned char *pFileName)
{
