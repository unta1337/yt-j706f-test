...
struct charger_device *quick_chg_dev = NULL;
...
u32 mt6360_aicr = 0, mt6360_mivr = 0;
...
int quick_mt6360_get_aicr(struct charger_device *chg_dev, u32 *uA)
{
	struct mt6360_pmu_chg_info *mpci = charger_get_data(chg_dev);
	int ret = 0;
...
int quick_mt6360_get_mivr(struct charger_device *chg_dev, u32 *uV)
{
	struct mt6360_pmu_chg_info *mpci = charger_get_data(chg_dev);
	int ret = 0;
...
extern int lc_otg_enable(bool en);
#endif
