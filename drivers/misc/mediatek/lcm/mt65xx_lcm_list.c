...
//yoga
#if defined(HX83102P_FHDP_DSI_VDO_BOE)
	&hx83102p_fhdp_dsi_vdo_boe_lcm_drv,
#endif
#if defined(NT36523W_FHDP_DSI_VDO_BOE)
	&nt36523w_fhdp_dsi_vdo_boe_lcm_drv,
#endif
//p522
#if defined(HX83102P_FHDP_DSI_VDO_BOE_P522)
	&hx83102p_fhdp_dsi_vdo_boe_p522_lcm_drv,
#endif
#if defined(NT36523W_FHDP_DSI_VDO_BOE_P522)
	&nt36523w_fhdp_dsi_vdo_boe_p522_lcm_drv,
#endif
#if defined(NT36523W_FHDP_DSI_VDO_INX_P522)
	&nt36523w_fhdp_dsi_vdo_inx_p522_lcm_drv,
#endif
};
...
//yoga
#if defined(HX83102P_FHDP_DSI_VDO_BOE)
	"hx83102p_fhdp_dsi_vdo_boe_drv"
#endif
#if defined(NT36523W_FHDP_DSI_VDO_BOE)
	"nt36523w_fhdp_dsi_vdo_boe_drv"
#endif
//p522
#if defined(HX83102P_FHDP_DSI_VDO_BOE_P522)
	"hx83102p_fhdp_dsi_vdo_boe_p522_drv",
#endif
#if defined(NT36523W_FHDP_DSI_VDO_BOE_P522)
	"nt36523w_fhdp_dsi_vdo_boe_p522_drv",
#endif
#if defined(NT36523W_FHDP_DSI_VDO_INX_P522)
	"nt36523w_fhdp_dsi_vdo_inx_p522_drv",
#endif
};
