...
#define KEY_LANGUAGE_SWITCH		633	/* Mute / unmute the microphone */
#define KEY_VOICE_ASSIST		634	/* Mute / unmute the microphone */
#define KEY_FULLSCREEN		635	/* Mute / unmute the microphone */
